...
public class HeroesData {
    ...
    static ArrayList<Hero> getListData(){
        ...
        for (int posisition = 0; posisition < heroNames.length;posisition++){
            Hero hero = new Hero();
            hero.setName(heroNames[posisition]);
            hero.setDetail(heroDetails[posisition]);
            hero.setPhoto(heroesImages[posisition]);
            list.add(hero);
        }
        return list;
    }
